...
const CreateRentaUseCase_1 = require("./CreateRentaUseCase");
...
describe("Create Rental", () => {
    ...
    beforeEach(() => {
        ...
        createRentalUseCase = new CreateRentaUseCase_1.CreateRentalUseCase(rentalsRepositoryInMemory, dayjsDateProvider, carsRepositoryInMemory);
    });
    it("should be able to create a rental", () => __awaiter(void 0, void 0, void 0, function* () {
