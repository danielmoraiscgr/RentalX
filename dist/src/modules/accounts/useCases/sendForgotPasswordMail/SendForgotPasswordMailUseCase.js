...
let SendForgotPasswordMailUseCase = class SendForgotPasswordMailUseCase {
    ...
    execute(email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const templatPath = (0, path_1.resolve)(__dirname, "..", "..", "views", "emails", "forgotPassword.hbs");
            if (!user) {
            ...
            yield this.mailProvider.sendMail(email, "Recuperação de senha", variables, templatPath);
        });
    }
};
