...
let ResetPasswordUserUseCase = class ResetPasswordUserUseCase {
    constructor(usersTokensRepositiry, dateProvider, usersRepository) {
        this.usersTokensRepositiry = usersTokensRepositiry;
        this.dateProvider = dateProvider;
        this.usersRepository = usersRepository;
    }
    execute({ token, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            const userToken = yield this.usersTokensRepositiry.findByRefreshToken(token);
            if (!userToken) {
            ...
            yield this.usersTokensRepositiry.deleteById(userToken.id);
        });
    }
};
