...
usersRoutes.patch("/avatar", ensureAuthenticate_1.ensureAuthenticated, uploadAvatar.single("avatar"), updateUserAvatarController.handle);
usersRoutes.get("/profile", ensureAuthenticate_1.ensureAuthenticated, profileUserController.handle);
